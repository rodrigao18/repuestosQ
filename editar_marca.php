...
<body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
        <div class="app-title">
            <div>
                <h1><i class="fas fa-edit"></i> Editar marca </h1>
                <p>Editar marca</p>
            </div>
            ...
            <div class="col-md-12">
                <div class="tile">
                    ...
                    <form method="POST" id="formularioEd">
                        ...
                        <button class="btn btn-primary pull-right" onclick="editar_categoria(event)">Editar marca</button>
                    </form>
                </div>
            </div>
        </div>
    ...
    <script type="text/javascript" src="js/editar_marca.js?vknet28"></script>
