...
let cargarProductos = async () => { 
	...
	let consulta=`SELECT id,codigo,nombre,codigo_proveedor,marca,proveedor, ubicacion,stock_m,stock FROM productos ORDER BY nombre ASC`;
