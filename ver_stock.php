...
<body class="app sidebar-mini rtl">
	...
	<main class="app-content">
		<div class="app-title">
			<div>
				<h1><i class="fa fa-shopping-cart"></i> Ver stock </h1>
				<p>Ver stock</p>
			</div>
			<ul class="app-breadcrumb breadcrumb side">
				<li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
				<li class="breadcrumb-item">stock</li>
				<li class="breadcrumb-item active"><a href="#">Ver stock</a></li>
			</ul>
		</div>
	...
	<script type="text/javascript" src="js/ver_stock.js?vknet28"></script>
