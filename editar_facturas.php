...
<body class="app sidebar-mini rtl">
	...
	<main class="app-content">
		<div class="app-title">
			<div>
				<h1><i class="fas fa-list"></i> Editar factura </h1>
				<p>Editar factura</p>
			...
			<ul class="app-breadcrumb breadcrumb side">
				...
				<li class="breadcrumb-item active"><a href="#">Editar factura</a></li>
						...
						<form method="POST" id="formularioEd">
							...
							<div class="form-row">
								...
								<div class="form-group col-md-6">
									...
									<input type="number" class="form-control" min=0 value="1" disabled required id="factura">
								</div>
	...
	<script type="text/javascript" src="js/editar_facturas.js?vknet32"></script>
